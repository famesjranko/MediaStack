...
| Every function defined under `scripts/` has at least one reference elsewhere in the tracked tree | `./tests/check.sh dead-code` → `tests/dead-code.sh` (also in `fast`) | `lint-shellcheck` |
