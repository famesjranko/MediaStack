...
#
# Unit coverage for the masked-and-validated password primitive:
...
printf '0\n' >"$PW_COUNT_FILE"
PW_SEQUENCE=("should-not-be-read")
...
printf '0\n' >"$PW_COUNT_FILE"
PW_SEQUENCE=("short" "ValidPass123")
out=$(ui_password_validated "Admin password" "" validate_admin_password)
...
printf '0\n' >"$PW_COUNT_FILE"
PW_SEQUENCE=("has'quote1234" "ValidPass123")
: >"$WARN_FILE"
out=$(ui_password_validated "Admin password" "" validate_admin_password)
